...
#### --f3
Estimates the f3-statistic (Reich et al. 2009). The default is to use the heterozygosity correction described in Patterson et al. 2012, Genetics. For the simple f3 statistic [img[https://latex.codecogs.com/gif.latex?\inline \large f3=(p3-p1)(p3-p2)]] use **--f3vanilla**.
